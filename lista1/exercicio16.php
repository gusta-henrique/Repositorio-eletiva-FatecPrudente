...
<form method="post">
<div class="mb-3">
              <label for="base" class="form-label">digite o preço: </label>
              <input type="number" id="preco" name="preco" class="form-control" required="">
            </div><div class="mb-3">
              <label for="expoente" class="form-label">digite o percentual de descconto:  </label>
...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        echo "<p> o preço R$$preco com $percentual% de desconto fica: R$$precoFinal </p>";
    }
